...
print_modname() {
  ...
  ui_print "      ⚡DISABLE THERMAL UNIVERSAL PRO VERSION⚡     "
busybox sleep 1
  ui_print "                   "
busybox sleep 1
  ui_print " Created By : R A M A"
  ui_print " Publisher  :@Rafaeruuu"
  ui_print " Credit      : @MasRamms "
busybox sleep 1
  ui_print " Install BusyBox"
  ui_print "               "
  ui_print " Tele : https://t.me/RafaeruUPDATE "
busybox sleep 1
  ui_print "⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⣀⡀⢀⢀⢀⢀⢀⢀⢀⢀"
busybox sleep 1
  ui_print "⢀⢀⢀⢀⢀⢀⢀⡤⠒⠋⠉⠁⢀⠉⠉⠑⠲⢄⡀⢀⢀⢀"
